...
public class Pelota {
    ...
    private void separarPelotasEnColision(Pelota other){
        //FIXME
        if(Vector2.add(this.velocity, other.velocity).magnitude() <= 0 && !GameManager.start){
